...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Telerik.XamarinForms.DataControls.dll", &exception_gchandle);
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Telerik.XamarinForms.Chart.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);

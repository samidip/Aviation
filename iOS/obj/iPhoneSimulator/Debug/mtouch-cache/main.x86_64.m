...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Telerik.XamarinForms.Common.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Telerik.XamarinForms.ChartRenderer.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Aviation.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
